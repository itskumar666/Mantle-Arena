...
// ── Deployed addresses (Mantle Sepolia, 2026-06-03/06)
// IMPORTANT: Must use static process.env.NEXT_PUBLIC_X — Next.js cannot
// inline dynamic process.env[key] lookups at build time.
const ADDRESSES = {
...
const stakeVaultAbi = [
  ...
  },
  {
    ...
    inputs: [{ name: "challengeId", type: "uint256" }, { name: "agentId", type: "uint256" }, { name: "backer", type: "address" }],
    outputs: [{ type: "uint256" }],
    stateMutability: "view",
  },
  {
